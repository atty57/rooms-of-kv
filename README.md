...
Companion code and data for [*[Two architectures that didn't help small-model agent memory on a free T4(https://dev.to/atty57/two-architectures-that-didnt-help-small-model-agent-memory-on-a-free-t4-d57)](#)*](https://dev.to/atty57/two-architectures-that-didnt-help-small-model-agent-memory-on-a-free-t4-d57).
